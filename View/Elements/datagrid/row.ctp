<tr class="table-row" <?php if(!empty($rowId)) echo ' id="' . $rowId . '"';?> data-depth="<?php echo $rowData['depth'];?>"<?php if (isset($rowData['action'])) { ?> data-action="<?php echo $rowData['action'];?>"<?php } ?>>
	<?php
